...
class UserControllerTest extends TestCase
{
    ...
    public function setUp():void
    {
        ...
        $this->LaminasUserAuthenticationPlugin = $this->createMock('LaminasUser\Controller\Plugin\LaminasUserAuthentication');
    ...
    public function testLoginActionValidFormRedirectFalse($isValid, $wantRedirect)
    {
        ...
        if ($isValid) {
            $adapter = $this->createMock('LaminasUser\Authentication\Adapter\AdapterChain');
    ...
    public function testRegisterAction($wantRedirect, $postRedirectGetReturn, $registerSuccess, $loginAfterSuccessWith)
    {
        ...
        $userService = $this->createMock('LaminasUser\Service\User');
